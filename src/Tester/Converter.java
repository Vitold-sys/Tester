...
public class Converter {
        private final String PATH_NUMBER = "Info/Numbers.properties";
        private final String PATH_DEGREE = "Info/Degree.properties";
        ...
        //Check for valid input by compare with extension files
        ...
        // Strings of the form xyz, xy, x are passed to the method and the order corresponding to them.
        ...
        private String convertNumber(String numb, String degree) {
            ...
            switch(sum) {
                case 3:
				   ...
				   //For degree 1 один and два are replaced by одна and две, respectively.
